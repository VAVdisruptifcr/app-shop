            ...
            <div class="section">
                ...
                <form method="post" action="{{ url('/admin/products/'.$product->id.'/edit') }}">
                    ...
                    <div class="row">
                        ...
                        <textarea class="form-control" name="long_description" placeholder="Describe ampliamente tu producto" rows="5">{{ old('long_description', $product->long_description) }}</textarea>
