        ...
        <div class="container">
            <div class="section">
                ...
                <form method="post" action="{{ url('/admin/categories') }}">
                    ...
                    <textarea class="form-control" name="description" rows="5" placeholder="Describe la nueva categoría">{{ old('description') }}</textarea>
                       

                        <button class="btn btn-info">Registrar categoría</button>
